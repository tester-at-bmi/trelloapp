...
it('opens board', { tags: ['@chrome', '@firefox', '@edge', '@webkit'] }, () => {
...
it('stars a board', { tags: ['@chrome', '@firefox', '@edge', '@webkit'] }, () => {
...
it('renames a board via api', { tags: ['@chrome', '@firefox', '@edge', '@webkit'] }, () => {
...
it('deletes board via api', { tags: ['@chrome', '@firefox', '@edge', '@webkit'] }, () => {
...
it('Shows an error when network does not work on creating board', { tags: ['@chrome', '@firefox', '@edge'] }, () => {
