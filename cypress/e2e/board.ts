...
it('adds a new list', { tags: ['@chrome', '@firefox', '@edge', '@webkit'] }, () => {
...
it('adds, updates, checks, and deletes a task', { tags: ['@chrome', '@firefox', '@edge', '@webkit'] }, () => {
...
it('opens task detail', { tags: ['@chrome', '@firefox', '@edge', '@webkit'] }, () => {
...
it('sorts tasks and lists', { tags: ['@chrome', '@firefox', '@edge', '@webkit'] }, () => {
...
it('shows an error message when there is a network error on creating list', { tags: ['@chrome', '@firefox', '@edge'] }, () => {
...
it('shows an error message when there is a network error on creating task', { tags: ['@chrome', '@firefox', '@edge'] }, () => {
...
it('update board name and delete board', { tags: ['@chrome', '@firefox', '@edge', '@webkit'] }, () => {
